  ...
  <div class="prices-page">
    ...
    <div class="table-container">
      <el-table :data="skewers" v-loading="loading" class="prices-table">
        ...
        <el-table-column prop="skewer_name" label="名称" min-width="220" align="center">
          <template #default="{ row }">
            <span class="table-name">{{ row.skewer_name }}</span>
          </template>
        </el-table-column>
        <el-table-column prop="category_name" label="类别" width="140" align="center">
          <template #default="{ row }">
        ...
        <el-table-column prop="unit_price" label="当前价格" width="160" align="center">
          <template #default="{ row }">
            <span class="table-price">¥{{ row.unit_price }}</span>
          </template>
        </el-table-column>
